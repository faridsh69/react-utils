      ...
      <div className={styles.wrapper}>
        ...
        <input
          ...
          className={clsx(
            ...
            styles[`noBorderRadiuses-${noBorderRadiuses[0]}`],
            styles[`noBorderRadiuses-${noBorderRadiuses[1]}`],
            styles[`noBorderRadiuses-${noBorderRadiuses[2]}`],
            styles[`noBorderRadiuses-${noBorderRadiuses[3]}`],
